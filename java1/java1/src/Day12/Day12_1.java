...
public class Day12_1 {
	...
	public static void main(String[] args) throws IOException {
		...
		String 성명2 = ("유재석");				System.out.println(성명2); // 객체 자동 생성
		...
		String str1 = new String(bytes); // String 바이트 -> 아스키코드로변환
		// 3. 확인
		...
		// 5. 확인
		System.out.println("바이트열내 6번 인덱스부터 4개 변환 : " + str2);
		
		// p. 498 예제2
			// system.out : 시스템클래스내 출력필드
			// system.in : 시스템클래스내 입력필드
		byte[] bytes2 = new byte[100]; // 100개 바이트를 저장 할 수 있는 배열
		...
		String str = new String(bytes2, 0, readByteNo-2);
											// 읽은 바이트 수 -2
		System.out.println("입력받는 바이트 -> 문자열 변환 : " + str);
