...
public class Day19_5 {
	...
	public static void main(String[] args) {
		...
		// p. 753 : TreeSet 클래스
			...
			//				가장 오른쪽에 있는 값이 가장 큰값
			// 5. TreeSet<기본자료형클래스> : 
			// 6. TreeSet<기본자료형클래스> : Comparable, Comparator 사용
		...
		System.out.println(scores.floor(95)); // 95포함 기준으로 왼쪽 노드[95보다 길거나 작은]
		System.out.println(scores.ceiling(85)); // 85포함 기준으로 오른쪽 노드[85보다 길거나 큰]
	
		// 4. 삭제
		System.out.println(scores.pollFirst()); // 가장 왼쪽 노드[가장 작은] 삭제
		System.out.println(scores.pollLast()); // 가장 오른쪽 노드[가장 큰] 삭제
