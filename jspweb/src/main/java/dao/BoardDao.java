...
public class BoardDao extends Dao{
	...
	public static BoardDao getBoardeDao() { // 왜?  // api에 get메소드 정의되어있음 // 코드의 간결함 // 계속 new를 사용하지 않아도됌
		return boardDao;
	}
	...
	// 4. 게시물 수적 메소드 [인수 : 수정할 게시물 번호 / 수정된 내용]
	...
	public ArrayList<Reply> rereplylist(int bno, int rno){
		...
		try {
			...
			return rereplylist;
		} catch (Exception e) {System.out.println("123" + e);}
		return null;
	}
	...
	public boolean replydelete(int rno) {
		...
		try {
			...
			ps.executeUpdate();
			return true;
		} catch (Exception e) {System.out.println("321" + e);}
			return false;
		}
	// 11. 게시물 댓글 조회수 메소드
