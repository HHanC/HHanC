...
public class porder {
	...
	public porder(String orderdate, String ordername, String orderphone, String orderaddress, int ordertotalpay,
	...
	public String toString() {
		return "porder [orderdate=" + orderdate + ", ordername=" + ordername + ", orderphone=" + orderphone
				+ ", orderaddress=" + orderaddress + ", ordertotalpay=" + ordertotalpay + ", orderactive=" + orderactive
				+ ", orderrequest=" + orderrequest + ", orderdeliverno=" + orderdeliverno + ", mno=" + mno + "]";
	}
