			...
			<div class="row">
				...
				%>
					...
					<form action="../update" method="post"> <!-- update 서블릿 파일로 post 전송 -->
						...
						배송주소 : 
						<input type="text" name="address1" value="<%=member.getMaddress().split("_")[0]%>" id="address1" name="address1" placeholder="우편번호">
						<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" name="address2" value="<%=member.getMaddress().split("_")[1]%>" id="address2" name="address2" placeholder="도로명주소">
						<input type="text" name="address3" value="<%=member.getMaddress().split("_")[2]%>" id="address3" name="address3" placeholder="지번주소">
						<span id="guide" style="color:#999;display:none"></span>
						<input type="text" name="address4" value="<%=member.getMaddress().split("_")[3]%>" id="address4" name="address4" placeholder="상세주소">
						<br>
