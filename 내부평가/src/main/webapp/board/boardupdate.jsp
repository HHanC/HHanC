...
<body>
	...
	<div class="container">
		...
		<h3> 글쓰기 </h3>
		<form action="/내부평가/board/boardlist.jsp" method="post" enctype="multipart/form-data" >
			제목 : <input type="text" name="btitle"> <br>
			<textarea name="bcontent" id="summernote"></textarea>
			첨부파일 : <input type="file" name="bfile"> <br>
			<input type="submit" value="수정"> <input type="reset" value="취소"> <input type="submit" value="목록">
		</form>
	</div>
